...
rule_4_1_check_content_1 = "If the target is to be detected in ① but not in ③, NG is assumed."
...
def execute_rule_4_1_programwise(input_file : str, 
    ...
    try:
        ...
        task_names = (
            ...
            .filter(pl.col("Unit").cast(pl.Utf8).str.to_lowercase() == "p&p")
        ...
        for program in unique_program_values:
            ...
            if program.lower() in task_names:
                ...
                ladder_autorun=ladder_pgm_wise.filter(pl.col("BODY").cast(pl.Utf8).str.to_lowercase() == 'autorun')
                ladder_memory_feeding=ladder_pgm_wise.filter(pl.col("BODY").cast(pl.Utf8).str.to_lowercase() == 'memoryfeeding')
                ladder_individual=ladder_pgm_wise.filter(pl.col("BODY").cast(pl.Utf8).str.to_lowercase() == 'individual')
                ...
                if len(ladder_autorun)!=0:
                    ...
                    for rung_num, rung_name, coil_attribute in zip(outcoil_rung_list, outcoil_rung_name_list, outcoil_attributes_list):
                        ...
                        coil_comment_dict=get_the_comment_from_program(variable=coil_operand, program=program, input_comment_data=program_comment_data)
                                            
                        
                        if regex_pattern_check(confirmation_jp, coil_comment_dict) and regex_pattern_check(unchuck_jp, coil_comment_dict):
                        ...
                        elif regex_pattern_check(confirmation_jp, coil_comment_dict) and regex_pattern_check(chuck_jp, coil_comment_dict):    
                        ...
                        elif regex_pattern_check(condition_jp, coil_comment_dict) and regex_pattern_check(unchuck_jp, coil_comment_dict):
                        ...
                        elif regex_pattern_check(condition_jp, coil_comment_dict) and regex_pattern_check(chuck_jp, coil_comment_dict):                        
                ...
                check_2_ladder_list= [ladder_memory_feeding,ladder_individual, ladder_autorun ]
                ...
                if len(unchuck_confirmation_operands)==0:
                    ...
                    sub_dict={'Result':["NG"], 'Task':[program], 'Section': ['AutoRun'], 
                        ...
                        'CheckItem':rule_4_1_check_item,
                        'Detail': [check_1_unchuck_NG_explanation],  'Status': ['']}
                ...
                if len(chuck_confirmation_operands)==0:
                    ...
                    sub_dict={'Result':["NG"], 'Task':[program], 'Section': ['AutoRun'], 
                        'RungNo':[""], "Target":[detail_dict], 
                        'CheckItem':rule_4_1_check_item,
                        'Detail': [check_1_chuck_NG_explanation],  'Status': ['']}
                ...
                for ladder, section in zip (check_2_ladder_list, check_2_section_list):
                    ...
                    if len(ladder)!=0:
                        ...
                        out_coil_df=ladder.filter(pl.col("OBJECT_TYPE_LIST").cast(pl.Utf8).str.to_lowercase() == 'coil')
                        outcoil_rung_list=list(out_coil_df['RUNG'])
                        outcoil_rung_name_list=list(out_coil_df['RUNG_NAME'])
                        outcoil_attributes_list=list(out_coil_df['ATTRIBUTES'])
                        ...
                        for rung_num, rung_name, coil_attribute in zip(outcoil_rung_list, outcoil_rung_name_list, outcoil_attributes_list):
                            ...
                            if coil_comment_dict!=None:
                                ...
                                if regex_pattern_check(unchuck_jp, coil_comment_dict):                            
                                    ...
                                    contact_df=ladder.filter((ladder["RUNG"] == rung_num) &
                                    ...
                                    for attrb in contact_attributes_list:
                                        ...
                                        if attrb['operand'] in list(unchuck_condition_operands):
                                            ...
                                            detail_dict['TARGET_VARIABLE']=coil_operand
                                            
                                            attrb_operand_index=unchuck_condition_operands.index(attrb['operand'])
                                            detail_dict['REFERENCE_RUNG']=unchuck_condition_ref_rung_dict[unchuck_condition_operands[attrb_operand_index]]
                                            ...
                                            sub_dict={'Result':["OK"], 'Task':[program], 'Section': [section], 
                                                'RungNo':[rung_num], "Target":[detail_dict], 
                                                'CheckItem':rule_4_1_check_item,
                                                'Detail': ["NONE"],  'Status': ['']}
                                            ...
                                            sub_dict={'Result':["NG"], 'Task':[program], 'Section': [section], 
                                                'RungNo':[rung_num], "Target":[detail_dict], 
                                                'CheckItem':rule_4_1_check_item,
                                                'Detail': [NG_EXP],  'Status': ['']}
                                    ...
                                    for attrb in contact_attributes_list:
                                        ...
                                        if attrb['operand'] in list(chuck_condition_operands):
                                            ...
                                            attrb_operand_index=chuck_condition_operands.index(attrb['operand'])
                                            detail_dict['REFERENCE_RUNG']=chuck_condition_ref_rung_dict[chuck_condition_operands[attrb_operand_index]]
                                            detail_dict['REFERENCE_SECTION']='AutoRun'
...
def execute_rule_4_1_functionwise(input_file : str, 
    ...
    try:
        ...
        for function_ in unique_function_values:
            ...
            if function_.lower() in task_names:
                ...
                ladder_pgm_wise=ladder_df.filter(ladder_df["FUNCTION_BLOCK"] == function_)
                
                #Get the section name in each of the PROGRAM
                unique_section_values=ladder_pgm_wise['BODY_TYPE'].unique()
                
            
                ladder_autorun=ladder_pgm_wise.filter(ladder_pgm_wise["BODY_TYPE"] == 'AutoRun')
                ladder_memory_feeding=ladder_pgm_wise.filter(ladder_pgm_wise["BODY_TYPE"] == 'MemoryFeeding')
                ladder_individual=ladder_pgm_wise.filter(ladder_pgm_wise["BODY_TYPE"] == 'Individual')
                ...
                if len(ladder_autorun)!=0:
                    ...
                    for rung_num, rung_name, coil_attribute in zip(outcoil_rung_list, outcoil_rung_name_list, outcoil_attributes_list):
                        ...
                        coil_operand=coil_attribute['operand']
                        coil_comment_dict=get_the_comment_from_function(variable=coil_operand, function=function_, input_comment_data=function_comment_data)
                        ...
                        if regex_pattern_check(confirmation_jp, coil_comment_dict) and regex_pattern_check(unchuck_jp, coil_comment_dict):
                            ...
                            sub_dict={'Result':["OK"], 'Task':[function_], 'Section': ['AutoRun'], 
                                                'RungNo':[rung_num], "Target":[detail_dict], 
                                                'CheckItem':rule_4_1_check_item,
                                                'Detail': ['NONE'],  'Status': ['']}
                ...
                if len(unchuck_confirmation_operands)==0:
                    ...
                    sub_dict={'Result':["NG"], 'Task':[function_], 'Section': ['AutoRun'], 
                        'RungNo':[""], "Target":[detail_dict], 
                        'CheckItem':rule_4_1_check_item,
                        'Detail': [check_1_unchuck_NG_explanation],  'Status': ['']}
                                ...
                                if regex_pattern_check(unchuck_jp, coil_comment_dict):                            
                                    ...
                                    for attrb in contact_attributes_list:
                                        ...
                                        if attrb['operand'] in list(unchuck_condition_operands):
                                            ...
                                            sub_dict={'Result':["OK"], 'Task':[function_], 'Section': [section], 
                                                'RungNo':[rung_num], "Target":[detail_dict], 
                                                'CheckItem':rule_4_1_check_item,
                                                'Detail': ["NONE"],  'Status': ['']}
                                            ...
                                            sub_dict={'Result':["NG"], 'Task':[function_], 'Section': [section], 
                                                'RungNo':[rung_num], "Target":[detail_dict], 
                                                'CheckItem':rule_4_1_check_item,
                                                'Detail': [NG_EXP],  'Status': ['']}
