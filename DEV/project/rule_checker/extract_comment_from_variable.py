...
def get_the_comment_from_program(variable: str, program:str='', input_comment_data:Dict=None)-> List:
    ...
    if special_case_flag:
        ...
        if comment_prefix!='NONE':
            ...
            variable_english_comment=comment_prefix.get("variable_english_comment", "NONE")
            variable_japanese_comment=comment_prefix.get("variable_japanese_comment", "NONE")
            documentation=comment_prefix.get("documentation", "NONE")

            
            if (variable_english_comment !="NONE") or (variable_japanese_comment !="NONE") or (documentation!="NONE"):
        ...
        if comment_suffix!='NONE':
            ...
            variable_english_comment=comment_suffix.get("variable_english_comment", "NONE")
            variable_japanese_comment=comment_suffix.get("variable_japanese_comment", "NONE")
        ...
        if comment_suffix!='NONE':
            ...
            member_english_comment=comment_suffix.get("member_english_comment", "NONE")
            member_japanese_comment=comment_suffix.get("member_japanese_comment", "NONE")
            member_documentation=comment_suffix.get("member_documentation", "NONE")
            
            
            if (member_english_comment!="NONE") or (member_japanese_comment!="NONE") or (member_documentation!="NONE"):
        ...
        if comment_program!='NONE':
            ...
            variable_english_comment=comment_program.get("variable_english_comment", "NONE")
            variable_japanese_comment=comment_program.get("variable_japanese_comment", "NONE")
...
########################################################
def get_the_comment_from_function(variable: str, function:str='', input_comment_data:Dict=None)-> List:
...
if __name__ == "__main__":
    ...
    kk=get_the_comment_from_function('L_RB_IN.B[833]','P122_27NG', input_comment_data=data)
    print(kk)
