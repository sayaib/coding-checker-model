...
#     out_list=[]
    ...
    ladder_df = pd.read_csv("C:/Users/aniln/OneDrive - OPTIMIZED SOLUTIONS LTD/DENSO/Data_Modelling/version3/data_model_Rule_46/data_model_Rule_46_programwise.csv")

    ladder_df=ladder_df[ladder_df['PROGRAM'] == 'P121_XXXPRS_Function1']
    ladder_df=ladder_df[ladder_df['BODY'] == 'Fault']
    ladder_df=ladder_df[ladder_df['RUNG'] == 1]
