...
def execute_rule_11(input_file : str, 
                    input_image:str,  
                    program_key:str,
            ...
            if "autorun" in lower_values and "preparation" in lower_values:
                ...
                for  row in ladder_body.iter_rows():
                    ...
                    if all([attr_type!=None, attr_type=='FlowControlDataJudge_ZDS']):
                        ...
                        logger.info(f"FlowControlDataJudge_ZDS found in \n program: {program} \n Body:{bdy} \n RUNG :{rg_order}  ")
                                                    ...
                                                    for data_ in data_inputs:
                                                        ...
                                                        if re.search(machine_no_input, data_):
                                                            if re.search(r';', data_):
                                                                ...
                                                                #Performing Check 4
                                                                rule_11_look_up_df_check=rule_11_look_up_df[rule_11_look_up_df['Task name']==program]
                                                                rule_11_operation_number_list=list(rule_11_look_up_df_check['Machine Number'])
                                                                
                                                                rule_11_operation_number_list=[str(int(ele)) for ele in rule_11_operation_number_list ]
                                                                ...
                                                                print(f"data_var_value_number: {data_var_value_number} \n rule_11_operation_number_list: {rule_11_operation_number_list}")
                                                                if data_var_value_number in rule_11_operation_number_list:
