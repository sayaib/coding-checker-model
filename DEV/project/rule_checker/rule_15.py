...
rule_15_cc2 = (
    "If a variable is not entered in the input variable in ③, it is assumed to be NG."
)
...
def execute_rule_15(
    ...
    try:
        ...
        rule_15_look_up_df["Machine Number"] = rule_15_look_up_df[
            "Machine Number"
        ].fillna(-1000)
                                                    ...
                                                    for data_ in data_inputs:
                                                        ...
                                                        if re.search(
                                                            ...
                                                            if re.search(r";", data_):
                                                                ...
                                                                # Performing Check 4
                                                                rule_15_look_up_df_check = rule_15_look_up_df[
                                                                    rule_15_look_up_df[
                                                                        "Task name"
                                                                    ]
                                                                    == program
                                                                ]
                                                                rule_15_machine_number_list = list(
                                                                    rule_15_look_up_df_check[
                                                                        "Machine Number"
                                                                    ]
                                                                )
                                                                ...
                                                                rule_15_machine_number_list = [
                                                                    str(int(ele))
                                                                    for ele in rule_15_machine_number_list
                                                                ]
                                                                # rule_15_machine_number_list = [
                                                                ...
                                                                if (
                                                                    data_var_value_number
                                                                    in rule_15_machine_number_list
                                                                ):
