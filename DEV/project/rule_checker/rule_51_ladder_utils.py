...
#     out_list=[]
    ...
    ladder_df = pd.read_csv("C:/Users/aniln/OneDrive - OPTIMIZED SOLUTIONS LTD/DENSO/Data_Modelling/version3/data_model_Rule_4_1_4_2_4_3_NG/data_model_Rule_4_1_4_2_4_3_NG_programwise.csv")
    # print(ladder_df)
    ladder_df=ladder_df[ladder_df['PROGRAM'] == 'P122_4_3NG2']
    ladder_df=ladder_df[ladder_df['BODY'] == 'Preparation']
    ladder_df=ladder_df[ladder_df['RUNG'] == 2]
    # print(ladder_df)
    # kk = check_self_holding(ladder_df)
    # kk = get_series_contacts_coil(pl.from_pandas(ladder_df))
    kk = get_parallel_contacts(pl.from_pandas(ladder_df))
    kk2 = get_format_parellel_contact_detail(kk)
    # kk = check_self_holding(ladder_df)
    pprint.pprint(kk)
    pprint.pprint(kk2)
