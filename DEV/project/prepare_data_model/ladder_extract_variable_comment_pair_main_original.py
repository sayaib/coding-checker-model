...
logger.add("comment_extraction_logs.log", 
...
def extract_variable_comment_programwise(ladder_program:pd.DataFrame, dest_comment_name:str, data_model_dir:str)-> None:
    ...
    try:
        ...
        for pg_name in program_names:
            ...
            for ext_var in external_vars:
                ...
                for var in ext_var.find_all("Variable"):
                    ...
                    for child in var.find_all():
                        ...
                        if child.name=="Text":
                            ...
                            if 'id' in list(child.attrs.keys()):
                                ...
                                if child.attrs['id']=='2':
                                    attribute_dict['variable_english_comment']=child.text
                                    attribute_dict['constant']=constant_type
                                    
                                    
                                elif child.attrs['id']=='1':
                                    attribute_dict['variable_japanese_comment']=child.text
                                    attribute_dict['constant']=constant_type
                    ...
                    variable_attributes[f"{ var.attrs['name'] }@PG@{pg_name}"] = attribute_dict
                    attribute_dict={}
        ...
        for pg_name in program_names:
            ...
            logger.info(f"Extracting comments from program {pg_name} and ExternalVars and Array Types")
                        ...
                        for child_element in variable.find_all("ElementComment"):
                            ...
                            for child_text in child_element.find_all("Text"):
                                ...
                                if child_text.attrs['id']=='1':
                                    attribute_dict['variable_japanese_comment']=child_text.text
                                if child_text.attrs['id']=='2':
                                    attribute_dict['variable_english_comment']=child_text.text
                            ...
                            variable_attributes[f"{variable.attrs['name']}{child_element.attrs['element']}@PG@{pg_name}"]=attribute_dict
                            attribute_dict={}
        ...
        for pg_name in program_names:
            ...
            logger.info(f"Extracting comments from program {pg_name} and Vars and Array Types")
            ...
            for _var in _vars:
                ...
                for variable in _var.find_all("Variable"):
                    ...
                    if any([re.search(array_rgx_pattern, variable_type.text), re.search(array_rgx_pattern_small, variable_type.text),
                        ...
                        if len(child_element_comments)>0:
                            ...
                            attribute_dict['access_type']=access_type
                            attribute_dict['documentation']= variable_documentation
                            variable_attributes[f"{ variable.attrs['name'] }@PG@{pg_name}"]=attribute_dict
                            attribute_dict={}
        ...
        global_vars = [global_var for global_var in ladder_program.find_all("GlobalVars")]
        array_rgx_pattern="ARRAY"
        array_flag=0
        attribute_dict={}
                    ...
                    if variable_comment:
                        ...
                        if variable_comment_text:
                            ...
                            if variable_comment_text.attrs['id']=='1':
                                attribute_dict['variable_japanese_comment']=variable_comment_text.text
                            if variable_comment_text.attrs['id']=='2':
                                attribute_dict['variable_english_comment']=variable_comment_text.text
                            ...
                            if child_elements:
                                ...
                                for child_element in variable.find_all("ElementComment"):
                                    ...
                                    variable_attributes[f"{variable.attrs['name']}{child_element.attrs['element']}@GBVAR"]=attribute_dict
                                    attribute_dict={}
                                    
                                    
                            else:
                                    attribute_dict['documentation']=documentation_text
                                    variable_attributes[f"{variable.attrs['name']}@GBVAR"]=attribute_dict
                                    attribute_dict={}
        ...
        global_namespaces = [global_name for global_name in ladder_program.find_all("GlobalNamespace")]
        attribute_dict={}
                    ...
                    if members:
                        for member in members:
                            ...
                            if member_documentation:
                                attribute_dict['member_documentation']=member_documentation.text
                            else:
                            ...
                            if member_text:
                                if member_text.attrs['id']=='1':
                                    ...
                                    attribute_dict['member_japanese_comment']=member_text.text
                                elif member_text.attrs['id']=='2':
                                    attribute_dict['member_english_comment']=member_text.text
                            ...
                            if data_type_spec_documentation:
                                attribute_dict['data_type_spec_documentation']=data_type_spec_documentation.text
                                attribute_dict['data_type_spec_name']=data_type_spec.attrs['name']
                            ...
                            variable_attributes[f"{member.attrs['name']}@GBNMSP"]=attribute_dict
                            attribute_dict={}
...
def main_program_extract_comments(input_ladder_file_path:str)-> None:
    ...
    dest_comment_file_name = os.path.splitext(os.path.basename(input_ladder_file_path))[0]
    # data_model_dir = 
    ...
    extract_variable_comment_programwise(ladder_program, f"{dest_comment_file_name}_programwise.json", data_model_dir)
    extract_variable_comment_functionwise(ladder_program, f"{dest_comment_file_name}_functionwise.json", data_model_dir)
...
if __name__ == "__main__":
    ...
    main_program_extract_comments(input_ladder_file_path, dest_comment_file_name, data_model_dir)  
