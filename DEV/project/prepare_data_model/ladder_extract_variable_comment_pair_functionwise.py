...
def extract_variable_comment_functionwise(ladder_program:pd.DataFrame, dest_comment_name:str, data_model_dir:str)-> None:
    
    try:
    
        function_blocks = [function["name"] for function in ladder_program.find_all("FunctionBlock")]
                        ...
                        if any([re.search(array_rgx_pattern, variable_type.text), re.search(array_rgx_pattern_small, variable_type.text),
                            ...
                            for child_element in variable.find_all("ElementComment"):
                                ...
                                for child_text in child_element.find_all("Text"):
                                    ...
                                    attribute_dict['variable_english_comment']= variable_english_comment
                                    attribute_dict['variable_japanese_comment']= variable_japanese_comment

                                variable_attributes[f"{variable.attrs['name']}{child_element.attrs['element']}@FN@{fn_name}"]=attribute_dict
                                attribute_dict={}
                            ...
                            variable_attributes[f"{variable.attrs['name']}@FN@{fn_name}"]=attribute_dict
                            attribute_dict={}
